...
import { Timer, Calendar, Users } from "lucide-react";
...
export const EventDescription: FC<EventDescriptionProps> = ({ data }) => {
  ...
  return (
    <main className="min-h-screen gap-4 w-full bg-[#0f0f0f] text-white grid grid-cols-1 lg:grid-cols-2 p-4">
      {/* Left Section */}
      <section className="p-8 flex flex-col gap-6 bg-[#171717] rounded-2xl shadow-2xl">
        {/* Hero */}
        <div className="flex items-center gap-4">
          ...
          />
          <h1 className="text-3xl font-bold text-violet-400">{data?.title}</h1>
        </div>
        ...
        >
          <DialogTrigger asChild>
            <Button
              className="bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 text-white px-6 py-3 text-lg rounded-xl shadow-lg w-fit transition-all"
        ...
        {/* Conveners */}
        <div className="mt-6">
          <h2 className="text-lg font-semibold text-violet-400 mb-3">Conveners</h2>
      ...
      {/* Right Section */}
      <section className="p-8 flex flex-col gap-6 bg-[#1b1b1b] rounded-2xl shadow-2xl">
        {/* About Event */}
        ...
        <div className="flex-1 overflow-y-auto pr-2">
          <h2 className="text-lg font-semibold text-violet-400 mb-3">Rounds</h2>
